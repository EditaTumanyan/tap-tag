...
const hoverLift =
  "hover:-translate-y-1.5 hover:shadow-[0_18px_40px_-18px_rgba(43,39,51,0.24)] hover:border-[#e56a78] transition-all duration-300";
    ...
    <div className="fade-up">
      <div style={{ textAlign: "center", padding: "72px 24px 56px" }}>
        <h1 className="text-[34px] md:text-[46px] lg:text-[60px]" style={{ fontFamily: "'Nunito',sans-serif", fontWeight: 700, margin: "0 0 20px", color: "#2b2733", lineHeight: 1.08 }}>
          Our Story. Our Mission. <span style={{ color: "#e56a78" }}>Our Impact.</span>
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[0.85fr_1fr] items-center" style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px 72px", gap: 56 }}>
        ...
        <div>
          <h2 style={{ fontFamily: "'Nunito',sans-serif", fontSize: 32, fontWeight: 700, margin: "0 0 24px", color: "#2b2733" }}>
            Who <span style={{ color: "#e56a78" }}>We Are</span>
          </h2>
      ...
      <div style={{ background: "#faf9fd", padding: "64px 24px", textAlign: "center" }}>
        <h2 style={{ fontFamily: "'Nunito',sans-serif", fontSize: 32, fontWeight: 700, margin: "0 0 12px", color: "#2b2733" }}>
          Meet Our <span style={{ color: "#e56a78" }}>Team</span>
        </h2>
      ...
      <div style={{ padding: "64px 0", overflow: "hidden" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ textAlign: "center", marginBottom: 14 }}>
            <h2 style={{ fontFamily: "'Nunito',sans-serif", fontSize: 32, fontWeight: 700, margin: "0 0 12px", color: "#2b2733" }}>
              Industry-Certified <span style={{ color: "#e56a78" }}>Expertise</span>
            </h2>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ textAlign: "center", marginTop: 36 }}>
            <a
              ...
              className="text-[#e56a78] border-b-[#f5d4d8] hover:text-[#b8435a] hover:border-b-[#e56a78]"
      ...
      <div style={{ background: "#faf9fd", padding: "64px 24px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <h2 style={{ fontFamily: "'Nunito',sans-serif", fontSize: 32, fontWeight: 700, margin: "0 0 48px", color: "#2b2733", textAlign: "center" }}>
            Our Core <span style={{ color: "#e56a78" }}>Values</span>
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4" style={{ gap: 24 }}>
            {coreValues.map((v, i) => (
              <div key={v.title} className="border-[#ecebf5] hover:-translate-y-1.5 hover:shadow-[0_18px_40px_-18px_rgba(21,18,63,0.28)] hover:border-[#e56a78] transition-all duration-300" style={{ background: "#fff", borderWidth: 1, borderStyle: "solid", borderRadius: 12, padding: "32px 28px", textAlign: "center" }}>
                <div style={{ width: 56, height: 56, borderRadius: 12, background: "#f5e0f5", margin: "0 auto 22px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <GlyphIcon paths={coreValuePaths[i]} color="#973e8f" />
                </div>
      ...
      <CtaBanner heading={<>Ready to Grow <span style={{ color: "#973e8f" }}>With TapTag?</span></>} subtext="Let's talk about your goals and explore how we can turn your next opportunity into measurable growth." />
    </div>
  );
}
